...
public class MemberController {
	...
	// 회원가입 정보입력 후
	@PostMapping("/signUp")
	public String userSignUp(@ModelAttribute MemberDto memberDto) throws Exception {
	...
	// 로그인 처리
	@PostMapping("/login")
	public String loginCheck(@ModelAttribute MemberDto memberDto, HttpSession session) throws Exception {
	...
	@PostMapping("/update")
	public String memberUpdate(@ModelAttribute MemberDto memberDto) throws Exception {
